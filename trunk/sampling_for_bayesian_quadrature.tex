...
%	\centering
	...
	\caption{The negative log density of the true normalization constant, versus different methods, on a one-dimensional example.}
\label{fig:nll}
\end{figure}
...
\begin{figure}
	...
	\caption{The posterior mean plus or minus two \acro{sd}s over $Z$ for different methods over a one-dimensional example (colours identical to those in Figure \ref{fig:nll}), compared to the true $Z$ (in black).}
\label{fig:logZ}
\end{figure}
...
The performance of methods tested is illustrated in Tables \ref{tbl:Combined Synthetic Results} and \ref{tbl:Combined Prawn Results}, and in Figures \ref{fig:nll} and \ref{fig:logZ}. Note that the mean predictions
