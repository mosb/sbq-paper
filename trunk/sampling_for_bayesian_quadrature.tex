...
\begin{figure}
	...
	\caption{The log density of the true evidence over a one-dimensional example for different methods, compared to the true $Z$ (in black).}
\label{fig:nll}
\end{figure}
...
Table \ref{tbl:Combined Synthetic Results} shows combined performance on the synthetic integrands listed above.  Here, \acro{BBQ*} and \ref{tbl:Combined Prawn Results}, and in Figures \ref{fig:nll} and \ref{fig:logZ}.
