...
We wish to evaluate the evidence $Z = \inty{\lfn} = \int \lfn(\lfv) p(\lfv) \ud\lfv$, an integral over non-negative likelihoods, $\lfn(\lfv)$, whose arguments are the parameters of the relevant model.
 ...
 \begin{figure}
 \centering
 \includegraphics[width=0.2\textwidth]{figures/gp_un.eps}
  \includegraphics[width=0.2\textwidth]{figures/gp_log.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.48\textwidth]{figures/int_hypers.eps}
