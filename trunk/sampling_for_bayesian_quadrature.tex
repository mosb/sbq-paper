...
\newcommand{\lfn}{\mathcal{L}}   % Likelihood function: Formerly r
\newcommand{\ltfm}{\log(\mathcal{L})}  % Likelihood function transformed: Formerly \tilde{r}
\newcommand{\var}{V}             % Variance: Formerly C
\newcommand{\lfv}{x}             % Likelihood function variable: Formerly \psi
