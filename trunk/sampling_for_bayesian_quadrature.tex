...
\begin{align}
 \mean{\tr\st}{\tr_s, \theta} & \simeq \nonumber\\
\mean{\tr\st}{\tr_s, m_\theta}
 \hspace{-1.52cm} + \left.\pderiv{\mean{\tr\st}{\tr_s, \theta}}{\theta}\right|_{m_\theta} (\theta - m_\theta)\\
