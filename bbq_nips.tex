...
\begin{figure}
\centering
\psfragfig[height=3.5cm]{figures/bmc_intro}
...
\p{\tr}{\tvr_s}\, \ud \tr 
\nonumber\\
& \phantom{:}= \mean{Z[m_{\tr|s}]}{Z_0,m_{\tr|s}} = \mean{\If}{\vr_s} + 
...
\begin{align} 
\cov{\If}{Z_0,\tvr_s,\Delta_c} = \secm{\If}{Z_0,\tvr_s} - \mean{\If}{Z_0,\tvr_s,\Delta_c}^2\,,
\end{align}
...
%	\centering
	\begin{subfigure}[b]{7.5cm}
		\psfragfig[width=5cm,height=4cm]{figures/plots/varplot_two_spikes_1d_nice1} 	
		\psfragfig[width=3cm]{figures/plots/legend}
		\caption{}
		\label{fig:se}
	\end{subfigure}
	\begin{subfigure}[b]{6cm}
		\psfragfig[width=6cm,height=4cm]{figures/plots/log_of_truth_plot_two_hills_1d_nice1}
		\caption{}
		\label{fig:nll}
	\end{subfigure}
