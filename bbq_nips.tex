...
{\bf Active Sampling:} Previous work on \acro{bq} has used either randomised or {\it a priori} fixed sampling schedules. We use active sampling, selecting sample locations which minimise the expected variance in $Z$.
