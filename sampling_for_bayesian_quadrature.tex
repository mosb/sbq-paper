...
\nonumber
\end{align*}
Note that $Z_0$ and its functional derivatives are analytic; our choice of $\tr_0$ permitted us to resolve the necessary integrals.
...
For future notational convenience, we assume that if we condition on $Z_0$, we will condition on its functional derivatives. This allows us to write our mean for  $\inty{\lfn}$
%
\begin{align}
