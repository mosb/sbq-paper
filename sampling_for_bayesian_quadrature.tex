...
\begin{document} 
\twocolumn[
\icmltitle{Model-based Active Learning of Normalization Constants
\\or\\
Doubly-Bayesian Quadrature for Estimating Model Evidence}
...
\section{Monte Carlo Approaches for Estimating Model Evidence}
...
& \bigl\langle \cov{\inty{\lfn}}{\chi_0,Z_0,\tvr_{s,a}}\mid \chi_0,Z_0,\tvr_{s}\bigr\rangle
\nonumber\\
& =  \mean{\chi[\tr]}{\chi_0,m_{\tr|s,m_\theta}}  - 
\int\mean{\inty{\lfn}}{Z_0,\tvr_{a,s}}^2
\nonumber\\
& \hspace{2cm}
\times\N{\tr_a}
{\tilde{m}_a }
...
we'd like to acknowledge the influence new samples may have on our beliefs about the quadrature-hyperparameters. We'd expect this would further promote exploration, particularly early on, so as to firm up our beliefs about the quadrature-hyperparameters. 
