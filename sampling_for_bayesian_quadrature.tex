...
\begin{figure}
	\centering
	\psfragfig[width=8cm,height=6cm]{figures/plots/varplot_simple}
	\caption{The posterior mean plus or minus two SDs over $Z$ for different methods (colours identical to those in Figure \ref{fig:nll}), compared to the true $Z$ (in black).}
\label{fig:logZ}
\end{figure}
