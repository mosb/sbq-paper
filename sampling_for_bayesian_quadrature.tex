...
\paragraph*{Active Sampling:} Previous work on \acro{bq} has used either randomized or {\it a priori} fixed sampling schedules. We demonstrate how to actively choose sample points in order to minimize the uncertainty in our integral.
