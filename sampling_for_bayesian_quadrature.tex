...
Quadrature involves evaluating $f(\lfv)$ at a vector of sample points $\vlfv_s$, giving $\vf\pha_s\deq f(\vlfv_s)$. Of course, this evaluation is usually a computationally expensive operation. The resultant sparsity of our samples introduces uncertainty about the function $f$ between them, and hence uncertainty about the integral $\inty{f}$.
...
However, because we place our GP model on the log-likelihood, as well as approximately integrate out quadrature lengthscales (see section blah), the location of the samples significantly changes the 
...
\begin{tabular}{ccc}
	...
	\input{figures/integrands/easy_1d.tikz} &
	\hspace{-.5cm}
	\setlength\fheight{2cm} 
	\setlength\fwidth{2cm}
	\input{figures/integrands/bumpy_1d_exp.tikz} 
	\hspace{-.5cm}	
	\setlength\fheight{2cm} 
	\setlength\fwidth{2cm}
...
\begin{figure}
	...
	\setlength\fheight{4cm} 
	\setlength\fwidth{4cm}
	\input{figures/plots/se_plot_easy_1d.tikz}
\end{figure}
...
\begin{figure}
	...
	\setlength\fheight{4cm} 
	\setlength\fwidth{4cm}
	\input{figures/plots/varplot_easy_1d.tikz}
\end{figure}
